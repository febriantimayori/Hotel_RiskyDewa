                ...
                while($d = mysqli_fetch_array($data)){
                  ...
                  <form action="update_users.php" method="POST">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama" value="<?php echo $d['nama'] ?>" placeholder="Masukan Pengguna">
                    </div>
                    <div class="form-group">
                      <label>Nama Pengguna</label>
                      <input type="text" class="form-control" name="username" value="<?php echo $d['username'] ?>" placeholder="Masukan Nama Pengguna">
                    </div>
                    <div class="form-group">
                      <label>Password</label>
                      <input type="password" class="form-control" name="password" value="<?php echo $d['password'] ?>" placeholder="Masukan Password">
                    </div>
                    <div class="form-group">
